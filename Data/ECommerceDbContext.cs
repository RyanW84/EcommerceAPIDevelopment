...
public class ECommerceDbContext(DbContextOptions<ECommerceDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Note: Removed Category query filter because it interferes with Include in Product queries
        // modelBuilder.Entity<Category>().HasQueryFilter(c => !c.IsDeleted);
        // Note: Not applying query filter to SaleItem as it can interfere with joins
    }
    ...
    public void SeedData()
    {
        ...
        var products = new List<Product>
        {
            ...
            new Product
            {
                ...
                Description = "2TB portable hard drive",
                Price = 89.99m,
                Stock = 22,
                IsActive = true,
                CategoryId = electronics.CategoryId,
            ...
            new Product
            {
                ...
                Description = "Educational picture book",
                Price = 12.99m,
                Stock = 50,
                IsActive = true,
                CategoryId = books.CategoryId,
            ...
            {
                Name = "Paint Set",
                Description = "Interior paint set with brushes",
                Price = 79.99m,
                Stock = 15,
                IsActive = true,
                CategoryId = homeAndGarden.CategoryId,
            ...
            {
                Name = "Dumbbells Set",
                Description = "Adjustable dumbbells 5-50lbs",
                Price = 199.99m,
                Stock = 6,
                IsActive = true,
                CategoryId = sports.CategoryId,
            ...
            {
                Name = "Shampoo",
                Description = "Moisturizing shampoo 16oz",
                Price = 8.99m,
                Stock = 60,
                IsActive = true,
            ...
            {
                Name = "Perfume",
                Description = "Designer fragrance 3.4oz",
                Price = 89.99m,
                Stock = 12,
                IsActive = true,
                CategoryId = beauty.CategoryId,
            ...
            {
                Name = "Board Game",
                Description = "Strategy board game for family",
                Price = 34.99m,
                Stock = 25,
                IsActive = true,
            ...
            new Product
            {
                ...
                Stock = 20,
                IsActive = true,
                CategoryId = automotive.CategoryId,
            },
            new Product
            {
            ...
            {
                Name = "Printer Paper",
                Description = "500 sheets printer paper",
                Price = 7.99m,
                Stock = 100,
                IsActive = true,
                CategoryId = office.CategoryId,
        ...
        var productsToDelete = allProducts
            .Where(p => p.CategoryId == electronics.CategoryId)
            .Take(3)
            .ToList();
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            var saleProducts = availableProducts
                .OrderBy(x => random.Next())
            ...
            if (saleProducts.Count > 0)
            {
                ...
                var customerAddress =
                    $"{addresses[random.Next(addresses.Length)]}, Anytown, ST 12345";
